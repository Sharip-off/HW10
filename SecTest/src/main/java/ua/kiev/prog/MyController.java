...
public class MyController {
    ...
    //======
    // Updating user date from admin panel
    @GetMapping(value = "admin_update-user")
    public String testAncor(@RequestParam("userLogin") String userLogin,
                            Model model) {
        System.out.println(userLogin);
        model.addAttribute("user", userService.findByLogin(userLogin));
        return "update-users";
    }

    @PostMapping(value = "/updateByAdmin")
    public String updateByAdmin(@RequestParam() String login,
